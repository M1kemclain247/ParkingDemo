...
public class PayArrearsTransaction extends AsyncTask<Transaction,Void,Void> {


    private Context context;
    private Handler mHandler;
    private OnPayArrearsResponse response;
    private boolean success = false;

    public PayArrearsTransaction(Context context){
        this.context = context;
        mHandler = new Handler();
    }
    public PayArrearsTransaction(Context context, OnPayArrearsResponse response){
        this.context = context;
        mHandler = new Handler();
    ...
    protected Void doInBackground(Transaction... params) {
        ...
        for(int i = 0 ;i<availableApis.length;i++) {
            ...
            final String tempResponse =  attemptPayArrears(availableApis[i],transaction.getShiftId(),transaction.getUsername(),String.valueOf(transaction.getTerminalId()), transaction.getPrecinctID(),
                    ...
                    String.valueOf(transaction.getTransactionDateTime()),String.valueOf(transaction.getRequestDateTime()));
    ...
    private String attemptPayArrears(String ip,String shiftID, String username, String terminalID,String precinctID, String receiptNo,
                                       String vehicleReg, String payment_mode_id,String amount,String paymentDateTime,String requestDateTime ){
