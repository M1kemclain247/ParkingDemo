...
public class VehicleLoginReceiptTask extends AsyncTask<MakeFineReceipt,Void,Boolean> {
    ...
    public VehicleLoginReceiptTask(Context context, TextView txtPrinterStatus, PublicAction PAct){
    ...
    @Override
    protected Boolean doInBackground(MakeFineReceipt... printReceipts) {
        ...
        MakeFineReceipt receipt =  printReceipts[0];
